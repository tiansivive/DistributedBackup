...
public class Values{
	...
	public static final String do_not_reply_to_message = "DONOTREPLY";
	public static final String UPDATE_DELETED_FILES_MESSAGE = "UPDATE";
	...
	public static final String fileIdPattern = "^[0-9A-Za-z]{64}$";
